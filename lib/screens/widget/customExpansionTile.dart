...
class CustomExpansionTile extends StatefulWidget {
  ...
  const CustomExpansionTile({
    ...
    this.collapsedBackgroundColor = const Color(0xffFEF6F5),
    this.textColor,
  ...
  final leadingSvgPath;
  // final LeadingIconleadingType;
        ...
        children: <Widget>[
          ListTileTheme.merge(
            iconColor: _isExpanded
                ? Colors.white
                : _iconColor.value ?? expansionTileTheme.iconColor,

            textColor: _isExpanded ? Colors.white : _headerColor.value,
            ...
            child: Container(
              decoration: BoxDecoration(
                color: _isExpanded ? orangeColor : Color(0xffFEF6F5),
              ...
              child: ListTile(
                ...
                leading:
                    // widget.leadingSvgPath != null
                    // ?
                    SvgPicture.asset(
                  widget.leadingSvgPath,
                  // height: 50,
                  // width: 50,
                  color: _isExpanded ? Color(0xffFEF6F5) : orangeColor,
                )
                // :
                // _buildLeadingIcon(context)
                ,
                title: widget.title,
                // subtitle: widget.subtitle ?? Text("asdf "),
